...
export class Parser {
   ...
   * @constructor
   */
    public constructor(UA: string, skipParsing: boolean = false) {
   ...
   * @public
   */
    public getBrowserName(toLowerCase?: boolean): string {
        if (toLowerCase) {
   ...
   */
    public getOSName(toLowerCase?: boolean): string {
   ...
   * @return {*}
   */
    public getPlatformType(toLowerCase = false): string {
   ...
   * @public
   */
    public getEngineName(toLowerCase?: boolean): string {
        if (toLowerCase) {
   ...
   */
    public satisfies(checkTree: any): boolean {
        const platformsAndOSes: any = {};
        let platformsAndOSCounter: number = 0;
        const browsers: any = {};
        let browsersCounter: number = 0;
   ...
   * @returns {boolean}
   */
    public isBrowser(browserName: string, includingAlias: boolean = false): boolean {
    ...
    public isOS(osName: string): boolean {
        return this.getOSName(true) === String(osName).toLowerCase();
    }

    public isPlatform(platformType: string): boolean {
        return this.getPlatformType(true) === String(platformType).toLowerCase();
    }

    public isEngine(engineName: string): boolean {
   ...
   * @returns {Boolean}
   */
    public is(anything: string): boolean {
   ...
   * @returns {Boolean}
   */
    public some(anythings: Array<string> = []): boolean {
